...
NAN_METHOD(BusConnection::RegisterAboutListener) {
  ...
  BusConnection* connection = node::ObjectWrap::Unwrap<BusConnection>(info.This());
  AboutListenerWrapper* wrapper = node::ObjectWrap::Unwrap<AboutListenerWrapper>(info[0].As<v8::Object>());
...
NAN_METHOD(BusConnection::EnablePeerSecurity) {
  ...
  BusConnection* connection = node::ObjectWrap::Unwrap<BusConnection>(info.This());
  AuthListenerWrapper* wrapper = node::ObjectWrap::Unwrap<AuthListenerWrapper>(info[1].As<v8::Object>());
